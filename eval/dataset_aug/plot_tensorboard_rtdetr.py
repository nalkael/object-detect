...
# load event file
event_file = "outputs/rtdetr/exp_rtdetr_with_aug/events.out.tfevents.1744054458.PC-RD-343.154124.0"
...
plt.savefig('rtdetr_aug_ap_metrics.svg', format='svg', bbox_inches='tight')
...
# Save as SVG (optional)
plt.savefig('rtdetr_aug_loss_metrics.svg', format='svg', bbox_inches='tight')
