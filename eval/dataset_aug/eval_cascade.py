...
cfg.MODEL.WEIGHTS = "outputs/cascade_rcnn_aug/model_0017499.pth" # cascade model without augmentation
...
with open("cascade_aug_predictions.pkl", "wb") as f:
    pickle.dump(predictions, f)

with open("cascade_aug_targets.pkl", "wb") as f:
    pickle.dump(targets, f)

# load pickel files
with open("cascade_aug_predictions.pkl", "rb") as f:
    predictions = pickle.load(f)

with open("cascade_aug_targets.pkl", "rb") as f:
...
with open('cascade_aug_results.txt', 'w') as f:
