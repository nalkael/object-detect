...
# load event file
event_file = "outputs/retina_net_with_aug/events.out.tfevents.1744049404.PC-RD-343.131511.0"
...
plt.savefig('retina_aug_ap_metrics.svg', format='svg', bbox_inches='tight')
...
# Save as SVG (optional)
plt.savefig('retina_aug_loss_metrics.svg', format='svg', bbox_inches='tight')
