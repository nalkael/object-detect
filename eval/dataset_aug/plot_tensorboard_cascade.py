...
# load event file
event_file = "outputs/cascade_rcnn_with_aug/events.out.tfevents.1744045566.PC-RD-343.110673.0"
...
plt.savefig('ascade_with_aug_ap_metrics.svg', format='svg', bbox_inches='tight')
...
# Save as SVG (optional)
plt.savefig('cascade_with_aug_loss_metrics.svg', format='svg', bbox_inches='tight')
