...
model_weights_path = "outputs/yolo_v8/exp_yolo_origin/weights/best.pt"
...
def export_results_to_pickle(result, image_path, export_dir):
    ...
    output_file = os.path.join(export_dir, f"{image_name}_yolov8_detections.pkl")
...
# Export visuals
image_name = os.path.splitext(os.path.basename(image_path))[0]
visual_file_name = f"{image_name}_yolov8_prediction.png"
