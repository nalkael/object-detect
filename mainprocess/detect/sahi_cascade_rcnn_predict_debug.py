...
model_config_path = "mainprocess/models/cascade_rcnn/model_config.yaml"
model_weights_path = "outputs/cascade_rcnn_origin/model_0015499.pth"
...
def export_results_to_pickle(result, image_path, export_dir):
    ...
    output_file = os.path.join(export_dir, f"{image_name}_cascade_detections.pkl")
...
# Export visuals
image_name = os.path.splitext(os.path.basename(image_path))[0]
visual_file_name = f"{image_name}_cascadercnn_prediction.png"
