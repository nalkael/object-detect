...
cfg.MODEL.RETINANET.SCORE_THRESH_TEST = 0.8 # set threshold for this model, different from Faster R-CNN!
...
cfg.DATASETS.TEST = ("my_dataset_val",) # for evaluation
...
cfg.MODEL.RETINANET.NUM_CLASSES = 7  # (see https://detectron2.readthedocs.io/tutorials/datasets.html#update-the-config-for-new-datasets)
# NOTE: this config means the number of classes, but a few popular unofficial tutorials incorrect uses num_classes+1 here.
cfg.OUTPUT_DIR = '/home/rdluhu/Dokumente/object_detection_project/outputs/retinanet'
